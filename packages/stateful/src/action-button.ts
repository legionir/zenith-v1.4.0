...
/**
 * متادیتای ذخیره‌شده روی دکمه برای tracking state.
 */
interface ButtonState {
  /** متن پیش‌فرض دکمه (قبل از loading). */
  defaultText: string;
  /** آیا دکمه در حال loading است. */
  isLoading: boolean;
}
...
export function processActionButton(
   ...
   */
  async function runAction(event: Event): Promise<void> {
