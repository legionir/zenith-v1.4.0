 ...
 */
export function indexHtmlTemplate(projectName) {
    return `<!DOCTYPE html>
 ...
 */
export function mainTsTemplate() {
 ...
 */
export function readmeTemplate(projectName) {
    return `# ${projectName}
 ...
 * قالب صفحه (برای SPA).
 */
export function pageTemplate(pageName) {
 ...
 * قالب Action.
 */
export function actionTemplate(actionName) {
 ...
 */
export function pwaManifestTemplate(projectName) {
 ...
 */
export function pwaServiceWorkerTemplate() {
 ...
 */
export function pwaViteConfigTemplate() {
    return `import { defineConfig } from 'vite';
import { zenithPlugin } from '@zenith/vite-plugin';
 ...
 */
export function pwaMainTsTemplate() {
 ...
 */
export function pwaReadmeTemplate(projectName) {
