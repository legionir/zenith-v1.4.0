export { renderToString, renderToStream, generateHydrationScript, generateFullPage, type SSRResult, type StreamChunk, } from './render';
/**
 ...
 *     // داخل این callback، getDOMGlobals() همان globals را برمی‌گرداند.
 *     // همچنین globalThis.document به globals.document delegate می‌کند.
 *   });
 */
export {
  domAls,
...
export { hydrate, startFromSSR, deserializeState, isHydrationMode, clearHydrationData, type HydrationResult, } from './hydrate';
