 ...
 */
const domAls = new AsyncLocalStorage();
export { domAls };
/**
 ...
 */
export function installDOMGlobalGetters() {
    ...
    for (const key of GLOBAL_KEYS) {
        ...
        const nativeValue = globalThis[key];
        Object.defineProperty(globalThis, key, {
            get() {
                ...
                return store ? store[key] : nativeValue;
            },
            configurable: true,
            enumerable: true,
        });
