 ...
 *   // → true
 */
export declare function evaluateExpression(expr: string, context: object): any;
/**
 ...
 */
export declare function compileExpression(expr: string): (context: object) => any;
/**
 ...
 */
export { getCacheSize } from './cache';
/**
