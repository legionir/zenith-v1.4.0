 ...
 */
type RouteStateProvider = () => { path: string; params: Record<string, string> } | undefined;
 ...
 */
let routeSignalProvider: RouteStateProvider | null = null;
 ...
 */
export function setRouteSignalProvider(provider: RouteStateProvider | null): void {
 ...
 */
export function createContext(state: Record<string, any>): Record<string, any> {
