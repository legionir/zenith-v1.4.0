// packages/runtime/dist/attributes.d.ts
//
...
// ── نحوه استفاده ──
//
// کاربر می‌تواند این interface را در پروژه‌ی خود import و استفاده کند:
//
//   ```ts
//   import type { ZenithAttributes } from '@zenith/runtime';
//
//   // برای extend کردن یک element:
//   const div: HTMLElement & ZenithAttributes = document.createElement('div');
//   div.setAttribute('zen-static', '');
//   ```
//
// یا برای augmentation در JSX (اگر از @zenith/jsx استفاده می‌کند):
//
//   ```ts
...
// ── ویژگی‌ها ──
//
// این interface تمام attribute های zen-* را شامل می‌شود. هر attribute
// اختیاری است (optional) چون ممکن است روی هر عنصری نباشد.
...
export interface ZenithAttributes {
  ...
  /** Generic bind برای هر attribute — استفاده از `[key: \`zen-bind:\${string}\`]`. */
  ...
  // FEATURE (v0.6.0): برای پلاگین @zenith/stateful.
